...
module.exports = function slidingMarker() {
    !function (a, b) {
        "use strict";
        ...
        b = b || {}, b.extend = b.extend || function m(a) {
            return Array.prototype.slice.call(arguments, 1).forEach(function (b) {
                if (b) for (var c in b) b[c] && b[c].constructor === Object ? a[c] && a[c].constructor !== Object ? a[c] = b[c] : (a[c] = a[c] || {}, m(a[c], b[c])) : a[c] = b[c]
            }), a
        };
        var c, d = google.maps.Marker, e = function (a, b, c) {
            ...
            easing: "easeInOutQuint", duration: 1e3, animateFunctionAdapter: function (a, b, d, f) {
                if (!c) {
                ...
                c.call(a, b, {
                    easing: d, duration: f, complete: function () {
                    }
                })
            }
        }, g = function (a, b) {
            ...
            b.extend(a.prototype, {
                _instance: null, originalSet: function () {
